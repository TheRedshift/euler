...
Ok, came back to this later, gave up and decided to just use numpy, and honestly I'd forgotten how awesome it is. Below is adapated from https://stackoverflow.com/questions/3939660/sieve-of-eratosthenes-finding-primes-python. This runs in 0.0086379 seconds, which is just insane.
